          ...
          columTemp.push({
            ...
            render: (text: any, record: any, index: any) => {
              if (itemKey === 'image' && dataCategory[index]?.image && dataCategory[index].image.length > 0) {
                return <img src={dataCategory[index].image} alt='Category Image' style={{ maxWidth: '50px' }} />
              }
              return text
            }
          })
  ...
  return (
    <div>
      <TemplateTable
        ...
        changeFunc={changeCategory}
        formEdit={
          <Fragment>
            <Form.Item label='Tên danh mục' name='name' rules={[{ required: true, message: 'Không được để trống!' }]}>
              <Input />
            </Form.Item>
          </Fragment>
        }
