...
import ButtonIcon from '../ButtonIcon/Button-Icon.componet'
            ...
            <div className='mt-5'>
              <ul>
                ...
                <li className='pb-6'>Màu Sắc: 
                    <button className='p-3 border w-20 mx-2 hover:border-orange-600'>Đỏ</button>
                    <button className='p-3 border w-20 mx-2 hover:border-orange-600'>Xanh</button>
                    <button className='p-3 border w-20 mx-2 hover:border-orange-600'>Vàng</button>
                    <button className='p-3 border w-20 mx-2 hover:border-orange-600'>Cam</button>
                    <button className='p-3 border w-20 mx-2 hover:border-orange-600'>Tím</button>

                </li>
                <li className='pb-6'>Kích Cỡ: 
                    <button className='p-3 border w-20 mx-2 hover:border-orange-600'>39</button>
                    <button className='p-3 border w-20 mx-2 hover:border-orange-600'>40</button>
                    <button className='p-3 border w-20 mx-2 hover:border-orange-600'>41</button>
                </li>
              </ul>
            </div>
            <QuantityProduct/>
