...
const Register: FunctionComponent<RegisterProps> = () => {
    ...
    return (
        ...
        <div css={cssRegister} className='box-border'>
            <h1 className='text-center my-[24px] font-semibold text-[24px] text-[#221f20] uppercase leading-[32px]'>Đăng ký</h1>
            ...
            <form action="" className='w-[90%] mx-auto text-[#6C6D70] flex form' onSubmit={handleSubmit(onSubmit)}>
                <div className='w-1/2'>
                    ...
                    <div className='flex mb-[16px]'>
                        <div className='w-1/2 px-[15px]'>
                            <label htmlFor="">Họ và tên:<b className='text-red-600'>*</b></label>
                            <Controller
                                control={control}
                                name="fullname"
                                render={({
                        ...
                        <div className='w-1/2 px-[15px]'>
                            <label htmlFor="">Nickname:<b className='text-red-600'>*</b></label>
                            <Controller
                                control={control}
                                name="nickname"
                                render={({
                    ...
                    <div className='flex mb-[16px]'>
                        <div className='w-1/2 px-[15px]'>
                            <label htmlFor="">Email:<b className='text-red-600'>*</b></label>
                            <Controller
                                control={control}
                                name="email"
                                render={({
                        ...
                        <div className='w-1/2 px-[15px]'>
                            <label htmlFor="">Điện thoại:<b className='text-red-600'>*</b></label>
                            <Controller
                                control={control}
                                name="phoneNumber"
                                render={({
                    ...
                    <div className='flex mb-[16px]'>
                        <div className='w-1/2 px-[15px]'>
                            <label htmlFor="">Ngày sinh:<b className='text-red-600'>*</b></label>
                            <Controller
                                control={control}
                                name="birthday"
                                render={({
                        ...
                        <div className='w-1/2 px-[15px]'>
                            <label htmlFor="">Giới tính:<b className='text-red-600'>*</b></label>
                            <Controller
                                control={control}
                                name="gender"
                                render={({
                    ...
                    <div className='px-[15px] mb-[16px]'>
                        <label htmlFor="">Địa chỉ:<b className='text-red-600'>*</b></label>
                        <Controller
                            control={control}
                            name="address"
                            render={({
                ...
                <div className='w-1/2'>
                    ...
                    <div className='px-[15px] mb-[16px]'>
                        <label htmlFor="">Mật khẩu:<b className='text-red-600'>*</b></label>
                        <Controller
                            control={control}
                            name="password"
                            render={({
                    ...
                    <div className='px-[15px] mb-[16px]'>
                        <label htmlFor="">Nhập lại mật khẩu:<b className='text-red-600'>*</b></label>
                        <Controller
                            control={control}
                            name="confirmPass"
                            render={({
                    ...
                    <div className='px-[15px] mb-[5px]'>
                        ...
                        <span>Đồng ý với các <b className='text-red-500 font-thin'>điều khoản</b> của IVY</span>
                    </div>
                    <div className='px-[15px] mb-[16px] '>
                        <input type="checkbox" name="" id="" />
